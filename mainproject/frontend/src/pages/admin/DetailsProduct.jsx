    ...
    return product ? (
        <div className="w-full">
            ...
            {user?.isAdmin && (
                ...
                >
                    <h1 className="text-blue-400 mb-5 text-4xl underline ">
                        Update Product Details
                    </h1>
                    <input
                        {...register("image")}
                        className="w-full text-2xl border-b outline-0 p-2 mb-5"
                        type="url"
                    ...
                    ></textarea>
                   <div className="flex justify-betweeen gap-40">
                     <button className="text-white ml-120 mt-5 text-xl px-5 py-3 rounded bg-red-400">
                        Update Product
                    </button>
                    <button
                        onClick={DeleteHandler}
                        type="button"
                        className="text-white mt-5 text-xl px-5 py-3 rounded bg-red-400"
                    >
                        Delete Product
                    </button>
                   </div>
